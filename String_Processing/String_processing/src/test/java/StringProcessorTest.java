...
//to count digits
    ...
    public void digitTest(){
        ...
        assertEquals(6, digit.calculateDigits("I'm 20 years old, born in 2003"));
...
// to count words
    ...
    public void correctWordCalc(){
        ...
        assertEquals(4, words.calculateWords("My name is Aishenur."));
        assertNotEquals(5, words.calculateWords("My name is Aishenur."));
        assertNotEquals(3, words.calculateWords("my name is 'Aishenur' "));
        assertEquals(4, words.calculateWords("my name is 'Aishenur' "));
    }
